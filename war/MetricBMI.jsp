...
<body >
	...
	<br>
	<form style="margin: 20px; clear:both" id="main-form" action="/MetricBMICalculator" class="form-horizontal">
		<div class="form-group">
			<label for="hieght" class="control-label col-sm-offset-2 col-sm-2">Height</label>
			<div class="col-sm-4">
			<input id="height" name="height" type="number" class=" form-control" placeholder="Height in meter" required></div>
		</div>
		<div class="form-group">
