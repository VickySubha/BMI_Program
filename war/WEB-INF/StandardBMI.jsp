...
<body >
	...
	<form style="margin: 20px; clear:both" id="main-form" action="/StandardBMICalculator" class="form-horizontal">
		<div class="form-group">
			...
			<div class="col-sm-2">
			<input id="height" name="feet" type="number" class=" form-control" placeholder="Feet" required></div>
		<div id="add-form-br"></div>
		<div class="col-sm-2">
			<input id="height" name="inch" type="number" class=" form-control" placeholder="Inch" required></div>
		</div>
		<div class="form-group">
